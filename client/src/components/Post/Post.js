...
const Home = () => {
  ...
  const getPosts = async () => {
    try {
      const res = await fetch(
        "https://anchors-discussion-forum-backend.vercel.app/post/topics",
        {
          method: "GET",
          headers: {
  ...
  const submitComment = async (id) => {
    try {
      const res = await fetch(
        `https://anchors-discussion-forum-backend.vercel.app/post/topics/${id}/comments`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const replyComment = async (topicId, commentId) => {
    try {
      const res = await fetch(
        `https://anchors-discussion-forum-backend.vercel.app/post/topics/${topicId}/comments/${commentId}/replies`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
